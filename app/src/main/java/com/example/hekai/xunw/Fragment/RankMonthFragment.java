...
public class RankMonthFragment extends Fragment{
    ...
    private void setRefreshListener() {
        swipeRefreshLayout.setOnRefreshListener(() ->{
            Observable<ApiResult<List<Food>>> foodDownLoadObservable = NetTool.getInstance(NetTool.HOST_LOCAL_URL_ONE_NET).getApiService(FoodApi.class).getFoodWithMonthRank(startPage,pageSize);
